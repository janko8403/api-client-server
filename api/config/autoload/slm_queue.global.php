...
use SlmQueueRabbitMq\Factory\RabbitMqQueueFactory;
...
return [
    'slm_queue' => [
         ...
         */
        'queues' => [
            'assembly-order-accepted' => $options,
        ],
        ...
        'queue_manager' => [
            'factories' => [
                'assembly-order-accepted' => RabbitMqQueueFactory::class,
                'assembly-order-updated' => RabbitMqQueueFactory::class,
            ],
        ],
    ],
    'slm-queue-rabbitmq' => [
